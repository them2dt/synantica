...
const badgeVariants = cva(
    "inline-flex items-center rounded-none border px-2 py-0.5 text-[11px] leading-4 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2",
    {
        variants: {
            variant: {
